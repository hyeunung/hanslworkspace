-- resolve_inquiry() 함수에 item_add(품목 추가 요청) 분기 복원
-- 20260330b에서 추가됐던 item_add 처리가 20260403a에서 누락된 회귀 수정.
-- v0.6.0 발주 상세 모달 '품목 추가 요청'으로 등록된 문의가 완료 처리되어도
-- 실제로 purchase_request_items에 품목이 추가되지 않던 사일런트 실패 해결.
