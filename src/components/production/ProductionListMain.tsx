  ...
  return (
    <div className="p-4 sm:p-5 space-y-4 bg-gray-50 min-h-screen">
      ...
      <div className="card-professional p-3 space-y-3">
        ...
        {/* Row 2: 요청월 필터 버튼 그룹 */}
        {/* Row 2: 요청월 필터 버튼 그룹 */}
        <div className="grid grid-cols-[75px_535px_auto] items-center gap-2 pt-2 border-t border-gray-100">
              ...
              <table className="text-left border-separate border-spacing-0 w-max min-w-full [&_th]:border-l-0 [&_td]:border-l-0 [&_th]:border-t-0 [&_td]:border-t-0 production-compact-table table-fixed">
                <thead className="whitespace-nowrap">
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th rowSpan={2} className="px-2 py-[2px] table-header-text text-gray-500 sticky bg-gray-50 z-30 border-b border-gray-200 shadow-[inset_-1px_0_0_0_#e5e7eb]" style={{ left: `${136 + productionCategoryPcbWidth}px`, width: `${pcbBoardWidth}px`, minWidth: `${pcbBoardWidth}px`, maxWidth: `${pcbBoardWidth}px` }}>보드명</th>
                ...
                <tbody className="divide-y divide-gray-100 text-[10px] text-gray-500 whitespace-nowrap">
                  {addingPcbRow && (
                    ...
                    >
                      ...
                      <td className="px-1 py-1 sticky bg-[#f8fbff] z-10 border-b border-gray-200 shadow-[inset_-1px_0_0_0_#e5e7eb]" style={{ left: `${136 + productionCategoryPcbWidth}px`, width: `${pcbBoardWidth}px`, minWidth: `${pcbBoardWidth}px`, maxWidth: `${pcbBoardWidth}px` }}>
                        <input
                          type="text"
                    ...
                    filteredPcbs.map((item, index) => {
                      ...
                      return (
                        ...
                        {renderEditableCell(
                          ...
                          item,
                          item.board_name,
                          'px-2 py-1.5 font-medium text-gray-900 sticky bg-white group-hover:bg-[#fafafa] transition-colors z-10 border-b border-gray-200 shadow-[inset_-1px_0_0_0_#e5e7eb]'
                        )}
                        {renderEditableCell(
                          item.id,
                          'pcb',
              ...
              <table className="text-left border-separate border-spacing-0 w-max min-w-full [&_th]:border-l-0 [&_td]:border-l-0 [&_th]:border-t-0 [&_td]:border-t-0 production-compact-table table-fixed">
                <thead className="whitespace-nowrap">
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th rowSpan={2} className="px-2 py-[2px] table-header-text text-gray-500 sticky bg-gray-50 z-30 border-b border-gray-200 shadow-[inset_-1px_0_0_0_#e5e7eb]" style={{ left: `${136 + productionCategoryCableWidth}px`, width: `${cableBoardWidth}px`, minWidth: `${cableBoardWidth}px`, maxWidth: `${cableBoardWidth}px` }}>품명</th>
                ...
                <tbody className="divide-y divide-gray-100 text-[10px] text-gray-700 whitespace-nowrap">
                  {addingCableRow && (
                    ...
                    >
                      ...
                      <td className="px-1 py-1 sticky bg-[#f8fbff] z-10 border-b border-gray-200 shadow-[inset_-1px_0_0_0_#e5e7eb]" style={{ left: '216px', width: `${cableBoardWidth}px`, minWidth: `${cableBoardWidth}px`, maxWidth: `${cableBoardWidth}px` }}>
                        <input
                          type="text"
