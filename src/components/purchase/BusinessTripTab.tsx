...
const COMPANY_CARDS = [
  ...
  { label: "공용2", number: "8967", value: "공용2 8967" },
  { label: "B", number: "9976", value: "B 9976" },
  ...
  const handleApproveTrip = useCallback(async (tripId: number) => {
    try {
      ...
      if (trip?.requester_id) {
        ...
        if (requester?.email && trip.linkedCard?.card_number) {
          supabase.functions.invoke("send_fcm_notification", {
            body: {
              ...
              data: {
                ...
                card_number: trip.linkedCard.card_number,
              },
            },
          }).catch(() => {});
        }
