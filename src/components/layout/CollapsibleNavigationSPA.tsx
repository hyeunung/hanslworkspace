...
export default function CollapsibleNavigationSPA({ role, isOpen = false, onClose }: NavigationProps) {
  ...
  return (
    <>
      ...
      <TooltipProvider delayDuration={0}>
        {/* 데스크톱 네비게이션 - 뷰포트 고정 */}
        <nav className="hidden lg:block fixed left-0 top-14 w-14 h-[calc(100vh-56px)] bg-white border-r border-gray-200 z-30">
