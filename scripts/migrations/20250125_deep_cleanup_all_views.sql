...
-- 10. Recreate vendor_contacts_with_vendor_name view without is_primary column  
...
COMMENT ON VIEW vendor_contacts_with_vendor_name IS 'View of vendor_contacts with vendor name. Updated on 2025-01-25 after column cleanup';
